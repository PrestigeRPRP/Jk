...
function randPhrase(){
    phrases = ["Sorry","owie","jho","lordgodjk","jacky","My life","betlog","You and Me",];
...
let playImg = "/play-icon.png";
let pauseImg = "/pause-icon.png";

playPauseBtn.addEventListener("click", function() {
    if (video.paused) {
        video.play();
        video.requestFullscreen(); // Make the video fullscreen
